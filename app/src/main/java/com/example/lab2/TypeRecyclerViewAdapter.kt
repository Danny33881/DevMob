...
import com.example.lab2.databinding.ActivityTypeItemBinding

class TypeRecyclerViewAdapter(private val Types: Array<String>): RecyclerView.Adapter<TypeRecyclerViewAdapter.ViewHolder>() {
