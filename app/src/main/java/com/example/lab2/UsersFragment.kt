...
//        val adapter = RecyclerViewAdapter(activitiesList, RecyclerViewAdapter.FragmentType.USERS)
//        adapter.onClick = {
//                position ->
//            val selectedActivity = activitiesList[position]
//            val detailFragment = ActivityDetailsFragment.newInstance(selectedActivity)
//
...
//        val activitiesList = ActivitiesList.getActivityData().filter { it.user == "me" }
        val recycler = view.findViewById<RecyclerView>(R.id.recycler)
        val adapter = RecyclerViewAdapter(emptyList(), RecyclerViewAdapter.FragmentType.USERS)
        recycler.adapter = adapter

        myVM.allActivities.observe(viewLifecycleOwner){
                newActivitiesList ->
