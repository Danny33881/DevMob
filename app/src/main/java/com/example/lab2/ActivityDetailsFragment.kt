...
//    private var activity: ActivityStatic? = null
//
//    override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
//        arguments?.let {
//            activity = it.getSerializable(ARG_ACTIVITY) as? ActivityStatic
//        }
//    }
//
...
//
//        @JvmStatic
//        fun newInstance(activity: ActivityStatic) =
...
class ActivityDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        whenWas.text = activity?.id.toString()
